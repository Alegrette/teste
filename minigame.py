...
submit_botao = tk.botao(name_frame, text="Enviar", width=20, font=("Arial", 12), bg="#3498DB", fg="white", bd=0, command=submit_name)
...
option_botao = []
for i in range(4):
    botao = tk.botao(option_frame, text=f"Opção {i+1}", width=20, font=("Arial", 12), bg=cores[i], fg="white", bd=0)
...
botao_sair=tk.botao(root, image=sair_img, bg="#0557e4", bd=0, command=sair)
